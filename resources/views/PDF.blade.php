...
<html>
<head>
    <title>{{$config['second_title_ar']?? ''}}</title>
...
<tr>
    <th style=" font-size: 16px;font-weight: 700;padding-right: 20px">
        ...
        <br>
        {{$config['fourth_title_ar']?? ''}}
        <br>
    </th>
    <th  style=" font-size: 16px;font-weight: 700;padding-right:<?php if($config['logo']=='karkuk'){ echo '45px';}else{echo '20px';}?>">
    @if($config['logo']=='karkuk')
    @include('logo.karkuk')
    @endif
    @if($config['logo']=='karbala')
    @include('logo.karbala')
    @endif
    @if($config['logo']=='karbala-ahindiy')
    @include('logo.karbala-ahindiy')
    @endif
    @if($config['logo']=='karbala-medical')
    @include('logo.karbala-medical')
    @endif
    @if($config['logo']=='karbala-alhassan')
    @include('logo.karbala-alhassan')
    @endif
    @if($config['logo']=='alhassanen')
    @include('logo.alhassanen')
    @endif
    
    
       <br> استمارة فحص المقبلين على الزواج
    </th>
    <th  style=" font-size: 14px;font-weight: 700;padding-right: <?php if($config['logo']=='karkuk'){ echo '45px';}else{echo '20px';}?>"> 
